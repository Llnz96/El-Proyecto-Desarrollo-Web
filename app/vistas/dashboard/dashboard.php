...
<<<<<<< HEAD
              <a href="#" class="btn btn-outline-light" tabindex="0">modo claro/oscuro</a>
            </li>
            <li class="nav-item me-2">
              <a href="/public/add_usuario" class="btn btn-outline-light" tabindex="1">Agregar usuarios</a>
            </li>
            <li class="nav-item">
              <a class="btn btn-primary" href="/public/add_servidor" tabindex="2">Agregar servidor</a>
=======
